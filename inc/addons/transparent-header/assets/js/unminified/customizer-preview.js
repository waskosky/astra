...
( function( $ ) {
	...
	astra_color_responsive_css( 'transparent-primary-header', 'astra-settings[transparent-submenu-color-responsive]', 'color', '.ast-theme-transparent-header .main-header-menu ul.sub-menu .menu-item .menu-link,.ast-theme-transparent-header .main-header-menu ul.sub-menu li > .ast-menu-toggle' );

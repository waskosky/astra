...
( function( $ ) {
	...
	astra_apply_responsive_color_property( 'astra-settings[transparent-header-colors-menu]', 'transparent-submenu-color-responsive', '.ast-theme-transparent-header .ast-above-header-menu .sub-menu, .ast-theme-transparent-header .ast-above-header-navigation .ast-above-header-menu .sub-menu a', 'color', 'transparent-above-header' );

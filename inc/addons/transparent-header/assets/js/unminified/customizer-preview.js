...
( function( $ ) {
	...
	// Primary SubMenu
	astra_apply_responsive_color_property( 'transparent-primary-header', 'astra-settings[transparent-header-colors-menu]', 'transparent-submenu-bg-color-responsive', '.ast-theme-transparent-header .main-header-menu ul.sub-menu ', 'background-color' );
	astra_apply_responsive_color_property( 'transparent-primary-header', 'astra-settings[transparent-header-colors-menu]', 'transparent-submenu-color-responsive', '.ast-theme-transparent-header .main-header-menu ul.sub-menu li a,.ast-theme-transparent-header .main-header-menu ul.sub-menu li > .ast-menu-toggle', 'color' );
	astra_apply_responsive_color_property( 'transparent-primary-header', 'astra-settings[transparent-header-colors-menu]', 'transparent-submenu-h-color-responsive', '.ast-theme-transparent-header .main-header-menu ul.sub-menu a:hover,.ast-theme-transparent-header .main-header-menu ul.sub-menu li:hover > a, .ast-theme-transparent-header .main-header-menu ul.sub-menu li.focus > a, .ast-theme-transparent-header .main-header-menu ul.sub-menu li.current-menu-item > a,	.ast-theme-transparent-header .main-header-menu ul.sub-menu li.current-menu-item > .ast-menu-toggle,.ast-theme-transparent-header .main-header-menu ul.sub-menu li:hover > .ast-menu-toggle, .ast-theme-transparent-header .main-header-menu ul.sub-menu li.focus > .ast-menu-toggle', 'color' );
	...
	astra_apply_responsive_color_property( 'transparent-above-header', 'astra-settings[transparent-header-colors-menu]', 'transparent-submenu-bg-color-responsive', '.ast-theme-transparent-header .ast-above-header-menu .sub-menu', 'background-color' );
	astra_apply_responsive_color_property( 'transparent-above-header', 'astra-settings[transparent-header-colors-menu]', 'transparent-submenu-color-responsive', '.ast-theme-transparent-header .ast-above-header-menu .sub-menu, .ast-theme-transparent-header .ast-above-header-menu .sub-menu a', 'color' );
	...
	astra_apply_responsive_color_property( 'transparent-below-header', 'astra-settings[transparent-header-colors-menu]', 'transparent-submenu-bg-color-responsive', '.ast-theme-transparent-header .ast-below-header-menu .sub-menu', 'background-color' );
	astra_apply_responsive_color_property( 'transparent-below-header', 'astra-settings[transparent-header-colors-menu]', 'transparent-submenu-color-responsive', '.ast-theme-transparent-header .ast-below-header-menu .sub-menu, .ast-theme-transparent-header .ast-below-header-menu .sub-menu a', 'color' );

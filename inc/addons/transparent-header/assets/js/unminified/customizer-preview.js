...
( function( $ ) {
	...
	// Primary SubMenu
	astra_apply_responsive_color_property( 'astra-settings[transparent-header-colors-submenu]', 'transparent-submenu-bg-color-responsive', '.ast-theme-transparent-header .main-header-menu ul.sub-menu, .ast-header-break-point.ast-theme-transparent-header .main-header-menu ul.sub-menu', 'background-color', 'transparent-primary-header' );
	astra_apply_responsive_color_property( 'astra-settings[transparent-header-colors-submenu]', 'transparent-submenu-color-responsive', '.ast-theme-transparent-header .main-header-menu ul.sub-menu li a,.ast-theme-transparent-header .main-header-menu ul.sub-menu li > .ast-menu-toggle', 'color', 'transparent-primary-header' );
	astra_apply_responsive_color_property( 'astra-settings[transparent-header-colors-submenu]', 'transparent-submenu-h-color-responsive', '.ast-theme-transparent-header .main-header-menu ul.sub-menu a:hover,.ast-theme-transparent-header .main-header-menu ul.sub-menu li:hover > a, .ast-theme-transparent-header .main-header-menu ul.sub-menu li.focus > a, .ast-theme-transparent-header .main-header-menu ul.sub-menu li.current-menu-item > a,	.ast-theme-transparent-header .main-header-menu ul.sub-menu li.current-menu-item > .ast-menu-toggle,.ast-theme-transparent-header .main-header-menu ul.sub-menu li:hover > .ast-menu-toggle, .ast-theme-transparent-header .main-header-menu ul.sub-menu li.focus > .ast-menu-toggle', 'color', 'transparent-primary-header' );
	...
	astra_apply_responsive_color_property( 'astra-settings[transparent-header-colors-menu]', 'transparent-menu-color-responsive', '.ast-theme-transparent-header .ast-above-header-navigation a, .ast-header-break-point.ast-theme-transparent-header .ast-above-header-navigation a, .ast-header-break-point.ast-theme-transparent-header .ast-above-header-navigation > ul.ast-above-header-menu > .menu-item-has-children:not(.current-menu-item) > .ast-menu-toggle', 'color', 'transparent-above-header' );
	...
	astra_apply_responsive_color_property( 'astra-settings[transparent-header-colors-submenu]', 'transparent-submenu-bg-color-responsive', '.ast-theme-transparent-header .ast-above-header-menu .sub-menu', 'background-color', 'transparent-above-header' );
	astra_apply_responsive_color_property( 'astra-settings[transparent-header-colors-submenu]', 'transparent-submenu-color-responsive', '.ast-theme-transparent-header .ast-above-header-menu .sub-menu, .ast-theme-transparent-header .ast-above-header-navigation .ast-above-header-menu .sub-menu a', 'color', 'transparent-above-header' );
	...
	astra_apply_responsive_color_property( 'astra-settings[transparent-header-colors-submenu]', 'transparent-submenu-bg-color-responsive', '.ast-theme-transparent-header .ast-below-header-menu .sub-menu', 'background-color', 'transparent-below-header' );
	astra_apply_responsive_color_property( 'astra-settings[transparent-header-colors-submenu]', 'transparent-submenu-color-responsive', '.ast-theme-transparent-header .ast-below-header-menu .sub-menu, .ast-theme-transparent-header .ast-below-header-menu .sub-menu a', 'color', 'transparent-below-header' );

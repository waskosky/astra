...
function astra_ext_transparent_header_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
	...
	$transparent_header_desktop = array(
		...
		'.ast-theme-transparent-header .main-header-menu .sub-menu .menu-link:hover,.ast-theme-transparent-header .main-header-menu .sub-menu .menu-item:hover > .menu-link, .ast-theme-transparent-header .main-header-menu .sub-menu .menu-item.focus > a,.ast-theme-transparent-header .main-header-menu .sub-menu li.current-menu-item > a, .ast-theme-transparent-header .main-header-menu .sub-menu li.current-menu-item > .ast-menu-toggle,.ast-theme-transparent-header .main-header-menu .sub-menu li:hover > .ast-menu-toggle, .ast-theme-transparent-header .main-header-menu .sub-menu .menu-item.focus > .ast-menu-toggle' => array(
	...
	$transparent_header_mobile = array(
		...
		'.ast-theme-transparent-header .main-header-menu .sub-menu .menu-link:hover,.ast-theme-transparent-header .main-header-menu .sub-menu .menu-item:hover > .menu-link, .ast-theme-transparent-header .main-header-menu .sub-menu .menu-item.focus > a,.ast-theme-transparent-header .main-header-menu .sub-menu li.current-menu-item > a,.ast-theme-transparent-header .main-header-menu .sub-menu li.current-menu-item > .ast-menu-toggle,.ast-theme-transparent-header .main-header-menu .sub-menu li:hover > .ast-menu-toggle, .ast-theme-transparent-header .main-header-menu .sub-menu .menu-item.focus > .ast-menu-toggle, .ast-theme-transparent-header .main-header-menu .sub-menu .menu-item.focus > .ast-menu-toggle' => array(

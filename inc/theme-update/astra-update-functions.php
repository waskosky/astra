 ...
 * @return void
 */
public function astra_theme_update_v2_0_0_customizer_optimization() {

	$json = astra_new_controls();
 ...
 * @return array
 */
public function astra_new_controls() {
 ...
 * @return void
 */
public function control_data_update( $new_options ) {
 ...
 * @return array
 */
public function group_item_operations( $group ) {

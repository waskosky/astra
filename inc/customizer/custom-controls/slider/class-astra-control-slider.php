...
class Astra_Control_Slider extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'ast-slider', $js_uri . 'slider.js', array( 'jquery', 'customize-base' ), ASTRA_THEME_VERSION, true );
		wp_enqueue_style( 'ast-slider', $css_uri . 'slider.css', null, ASTRA_THEME_VERSION );
	}

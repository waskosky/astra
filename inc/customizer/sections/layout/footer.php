...
if ( ! defined( 'ABSPATH' ) ) {
	...
	$wp_customize->add_control( new Ast_Control_Radio_Image( $wp_customize, ASTRA_THEME_SETTINGS . '[footer-sml-layout]', array(
	 ...
	 * Option: Divider
	 */
	$wp_customize->add_control( new Ast_Control_Divider( $wp_customize, ASTRA_THEME_SETTINGS . '[section-ast-small-footer-layout-info]', array(
		'type'        => 'ast-divider',
		'section'     => 'section-footer-small',
		'priority'    => 10,
		'settings'    => array(),
	...
	$wp_customize->add_control( ASTRA_THEME_SETTINGS . '[footer-sml-section-1-credit]', array(
		'type'        => 'textarea',
		'section'     => 'section-footer-small',
		'priority'    => 20,
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( ASTRA_THEME_SETTINGS . '[footer-sml-section-1-credit]', array(
	 ...
	 * Option: Divider
	 */
	$wp_customize->add_control( new Ast_Control_Divider( $wp_customize, ASTRA_THEME_SETTINGS . '[section-ast-small-footer-typography]', array(
		'type'     => 'ast-divider',
		'section'  => 'section-footer-small',
		'priority' => 35,
		'settings' => array(),
	...
	$wp_customize->add_control( ASTRA_THEME_SETTINGS . '[footer-sml-divider]', array(
		'type'        => 'number',
		'section'     => 'section-footer-small',
		'priority'    => 40,
	...
	$wp_customize->add_control( ASTRA_THEME_SETTINGS . '[footer-layout-width]', array(
		'type'        => 'select',
		'section'     => 'section-footer-small',
		'priority'    => 35,

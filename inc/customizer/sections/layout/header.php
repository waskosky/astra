...
if ( ! defined( 'ABSPATH' ) ) {
	...
	$wp_customize->add_control( new Ast_Control_Radio_Image( $wp_customize, ASTRA_THEME_SETTINGS . '[header-layouts]', array(
	...
	$wp_customize->add_control( ASTRA_THEME_SETTINGS . '[disable-primary-nav]', array(
		'type'        => 'checkbox',
		'section'     => 'section-header',
	...
	$wp_customize->add_control( ASTRA_THEME_SETTINGS . '[header-main-sep]', array(
		'type'        => 'number',
		'section'     => 'section-header',
		'priority'    => 25,
	...
	*/
	$wp_customize->add_control( new Ast_Control_Divider( $wp_customize, ASTRA_THEME_SETTINGS . '[header-main-menu-label-divider]', array(
		'type'     => 'ast-divider',
		'section'  => 'section-header',
		'priority' => 35,
		'settings' => array(),

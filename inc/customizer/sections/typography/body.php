...
if ( ! defined( 'ABSPATH' ) ) {
	...
	$wp_customize->add_control( new Ast_Control_Typography( $wp_customize, ASTRA_THEME_SETTINGS . '[body-font-family]', array(
	...
	$wp_customize->add_control( new Ast_Control_Typography( $wp_customize, ASTRA_THEME_SETTINGS . '[body-font-weight]', array(
	...
	$wp_customize->add_control( new Ast_Control_Responsive( $wp_customize, ASTRA_THEME_SETTINGS . '[font-size-body]', array(
		'type'     => 'ast-responsive',
		'section'  => 'section-body-typo',
		'priority' => 20,
	...
	$wp_customize->add_control( new Ast_Control_Responsive( $wp_customize, ASTRA_THEME_SETTINGS . '[body-line-height]', array(
		'type'     => 'ast-responsive',
		'section'  => 'section-body-typo',
		'priority' => 25,

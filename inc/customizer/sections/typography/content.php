...
if ( ! defined( 'ABSPATH' ) ) {
	...
	$wp_customize->add_control( new Astra_Control_Responsive( $wp_customize, ASTRA_THEME_SETTINGS . '[font-size-h1]', array(
		'type'     => 'ast-responsive',
		'section'  => 'section-content-typo',
		'priority' => 5,
	...
	$wp_customize->add_control( new Astra_Control_Responsive( $wp_customize, ASTRA_THEME_SETTINGS . '[font-size-h2]', array(
		'type'     => 'ast-responsive',
		'section'  => 'section-content-typo',
		'priority' => 10,
		'label'    => __( 'Font Size', 'astra' ),
	...
	$wp_customize->add_control( new Astra_Control_Responsive( $wp_customize, ASTRA_THEME_SETTINGS . '[font-size-h3]', array(
		'type'     => 'ast-responsive',
		'section'  => 'section-content-typo',
		'priority' => 15,
		'label'    => __( 'Font Size', 'astra' ),
	...
	$wp_customize->add_control( new Astra_Control_Responsive( $wp_customize, ASTRA_THEME_SETTINGS . '[font-size-h4]', array(
		'type'     => 'ast-responsive',
		'section'  => 'section-content-typo',
		'priority' => 20,
		'label'    => __( 'Font Size', 'astra' ),

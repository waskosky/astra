	...
	class Gutenberg_Editor_CSS {
		...
		public static function get_css() {
			...
			$desktop_css = array(
				...
				'.block-editor-page #wpwrap .edit-post-visual-editor a' => array(
					'color' => esc_attr( $link_color ),
				),
				// Global selection CSS.
				'.block-editor-page #wpwrap .edit-post-visual-editor ::selection,.editor-block-list__layout .editor-block-list__block.is-multi-selected .editor-block-list__block-edit:before' => array(
					'background-color' => esc_attr( $theme_color ),
				),
				'.block-editor-page #wpwrap .edit-post-visual-editor ::selection,.editor-block-list__layout .editor-block-list__block.is-multi-selected .editor-block-list__block-edit' => array(
					'color' => esc_attr( $highlight_theme_color ),
				),

				'.block-editor-page #wpwrap .edit-post-visual-editor' => astra_get_background_obj( $box_bg_obj ),
				'.block-editor-page #wpwrap .edit-post-visual-editor .editor-post-title__block,.block-editor-page #wpwrap .edit-post-visual-editor .editor-default-block-appender,.block-editor-page #wpwrap .edit-post-visual-editor .editor-block-list__block' => array(
					'max-width' => astra_get_css_value( $site_content_width + 40, 'px' ),
				),
				'.block-editor-page #wpwrap .edit-post-visual-editor .editor-block-list__block[data-align=wide]' => array(
					'max-width' => astra_get_css_value( $site_content_width + 40 + 200, 'px' ),
				),
				'.block-editor-page #wpwrap .edit-post-visual-editor .editor-post-title__block .editor-post-title__input,  .block-editor-page #wpwrap .edit-post-visual-editor h1, .block-editor-page #wpwrap .edit-post-visual-editor h2, .block-editor-page #wpwrap .edit-post-visual-editor h3, .block-editor-page #wpwrap .edit-post-visual-editor h4, .block-editor-page #wpwrap .edit-post-visual-editor h5, .block-editor-page #wpwrap .edit-post-visual-editor h6' => array(
				...
				'.block-editor-page #wpwrap .edit-post-visual-editor p,.block-editor-page #wpwrap .edit-post-visual-editor .editor-block-list__block p' => array(
					'font-size' => astra_responsive_font( $body_font_size, 'desktop' ),
				),
				'.block-editor-page #wpwrap .edit-post-visual-editor p,.block-editor-page #wpwrap .edit-post-visual-editor .editor-block-list__block p, .block-editor-page #wpwrap .edit-post-visual-editor .wp-block-latest-posts a' => array(
				...
				'.block-editor-page #wpwrap .edit-post-visual-editor .editor-post-title__block .editor-post-title__input' => array(
				...
				'.block-editor-page #wpwrap .edit-post-visual-editor .editor-block-list__block, .block-editor-page #wpwrap .edit-post-visual-editor .editor-post-title__block .editor-post-title__input, .block-editor-page #wpwrap .edit-post-visual-editor h1,.block-editor-page #wpwrap .edit-post-visual-editor h2,.block-editor-page #wpwrap .edit-post-visual-editor h3,.block-editor-page #wpwrap .edit-post-visual-editor h4,.block-editor-page #wpwrap .edit-post-visual-editor h5,.block-editor-page #wpwrap .edit-post-visual-editor h6' => array(
					'color' => esc_attr( $text_color ),
				),
				// Blockquote Text Color.
				'.block-editor-page #wpwrap .edit-post-visual-editor blockquote, .block-editor-page #wpwrap .edit-post-visual-editor blockquote a' => array(
					'color' => astra_adjust_brightness( $text_color, 75, 'darken' ),
				),
				'.block-editor-page #wpwrap .edit-post-visual-editor blockquote' => array(
					'border-color' => astra_hex_to_rgba( $link_color, 0.05 ),
				),
				// Heading H1 - H6 font size.
				'.block-editor-page #wpwrap .edit-post-visual-editor h1' => array(
					'font-size' => astra_responsive_font( $heading_h1_font_size, 'desktop' ),
				),
				'.block-editor-page #wpwrap .edit-post-visual-editor h2' => array(
					'font-size' => astra_responsive_font( $heading_h2_font_size, 'desktop' ),
				),
				'.block-editor-page #wpwrap .edit-post-visual-editor h3' => array(
					'font-size' => astra_responsive_font( $heading_h3_font_size, 'desktop' ),
				),
				'.block-editor-page #wpwrap .edit-post-visual-editor h4' => array(
					'font-size' => astra_responsive_font( $heading_h4_font_size, 'desktop' ),
				),
				'.block-editor-page #wpwrap .edit-post-visual-editor h5' => array(
					'font-size' => astra_responsive_font( $heading_h5_font_size, 'desktop' ),
				),
				'.block-editor-page #wpwrap .edit-post-visual-editor h6' => array(
			...
			if ( 'content-boxed-container' === $container_layout || 'boxed-container' === $container_layout ) {
				$boxed_container = array(
					'.block-editor-page #wpwrap .edit-post-visual-editor .editor-writing-flow' => array(
						'max-width'        => 'calc( ' . astra_get_css_value( $site_content_width, 'px' ) . ' - 40px )',
						'margin'           => '0 auto',
						'background-color' => '#fff',
						'overflow'         => 'hidden',
					),
					'.block-editor-page #wpwrap .gutenberg__editor' => array(
						'background-color' => '#f5f5f5',
					),
					'.block-editor-page #wpwrap .editor-block-list__layout, .block-editor-page #wpwrap .editor-post-title'  => array(
						'padding-top'    => '5.34em',
						'padding-bottom' => '5.34em',
						'padding-left'   => 'calc( 6.67em - 14px )',
						'padding-right'  => 'calc( 6.67em - 14px )',
					),
					'.block-editor-page #wpwrap .editor-block-list__layout' => array(
						'padding-top' => '0',
					),
					'.block-editor-page #wpwrap .editor-post-title' => array(
						'padding-bottom' => '0',
					),
					'.block-editor-page #wpwrap .edit-post-visual-editor .editor-block-list__block' => array(
					...
					'.block-editor-page #wpwrap .edit-post-visual-editor .editor-block-list__block[data-align=full]' => array(
						'margin-left'  => '-6.67em',
						'margin-right' => '-6.67em',
					),
				);

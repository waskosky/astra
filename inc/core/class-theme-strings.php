...
if ( ! function_exists( 'astra_default_strings' ) ) {
	...
	function astra_default_strings( $key, $echo = true ) {
		...
		$defaults = apply_filters( 'astra_default_strings', array(
			...
			'string-full-width-search-placeholder'   => __( 'Start Typing...', 'astra' ),
			'string-header-cover-search-placeholder' => __( 'Start Typing...', 'astra' ),
			...
			'string-single-navigation-next'          => __( 'Next Post', 'astra' ) . ' <span class="ast-right-arrow">&rarr;</span>',
			'string-single-navigation-previous'      => '<span class="ast-left-arrow">&larr;</span> ' . __( 'Previous Post', 'astra' ),

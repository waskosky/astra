			...
			$top_links = apply_filters(
				...
				array(
					'astra-theme-info' => array(
						'title' => __( '<img draggable="false" role="img" class="emoji" alt="Lightening Fast Icon" src="https://s.w.org/images/core/emoji/12.0.0-1/svg/26a1.svg"> Lightning Fast & Fully Customizable WordPress theme!', 'astra' ),
					),
				)
			);

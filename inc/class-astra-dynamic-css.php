	...
	class Astra_Dynamic_CSS {
		...
		public static function return_output() {
			...
			$css_output = array(
				...
				// Button Typography.
				'.menu-toggle, button, .ast-button, .button, input#submit, input[type="button"], input[type="submit"], input[type="reset"], .ast-gtn-btn .wp-block-button__link' => array(
				...
				'button:focus, .menu-toggle:hover, button:hover, .ast-button:hover, .button:hover, input[type=reset]:hover, input[type=reset]:focus, input#submit:hover, input#submit:focus, input[type="button"]:hover, input[type="button"]:focus, input[type="submit"]:hover, input[type="submit"]:focus, .ast-gtn-btn .wp-block-button__link:hover, .ast-gtn-btn .wp-block-button__link:focus' => array(

...
if ( ! function_exists( 'astra_masthead_toggle_buttons_primary' ) ) {
	...
	function astra_masthead_toggle_buttons_primary() {
		...
		<div class="ast-button-wrap">
			<button type="button" class="menu-toggle main-header-menu-toggle <?php echo esc_attr( $menu_label_class ); ?>" <?php echo esc_attr( apply_filters( 'astra_nav_toggle_data_attrs', '' ) ); ?> aria-controls='primary-menu' aria-expanded='false'>

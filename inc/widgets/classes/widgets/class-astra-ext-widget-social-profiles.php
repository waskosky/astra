...
if ( ! class_exists( 'Astra_Ext_Widget_Social_Profiles' ) ) :

	/**
	 * Astra_Ext_Widget_Social_Profiles
	 *
	 * @since 1.6.0
	 */
	class Astra_Ext_Widget_Social_Profiles extends WP_Widget {
		...
		function register_admin_scripts() {
			wp_register_script( 'astra-widgets-' . $this->id_base, ASTRA_EXT_WIDGETS_URL . 'assets/js/unminified/astra-widget-social-profiles.js' );
			wp_register_style( 'astra-widget-social-profiles-admin', ASTRA_EXT_WIDGETS_URL . 'assets/css/unminified/astra-widget-social-profiles-admin.css' );
		}
		...
		function register_scripts() {
			// Dynamic CSS.
			wp_register_style( 'astra-widgets-' . $this->id_base, ASTRA_EXT_WIDGETS_URL . 'assets/css/unminified/astra-widget-social-profiles.css' );
		}

...
if ( ! class_exists( 'Astra_Ext_Widget_List_Icons' ) ) :

	/**
	 * Astra_Ext_Widget_List_Icons
	 *
	 * @since 1.6.0
	 */
	class Astra_Ext_Widget_List_Icons extends WP_Widget {
		...
		function __construct() {
			...
			add_filter( 'astra_dynamic_css', array( $this, 'dynamic_css' ) );
		...
		function register_admin_scripts() {
			wp_register_script( 'astra-widgets-' . $this->id_base, ASTRA_EXT_WIDGETS_URL . 'assets/js/unminified/astra-widget-list-icons.js' );
		}
		...
		function register_scripts() {
			wp_register_style( 'astra-widgets-' . $this->id_base, ASTRA_EXT_WIDGETS_URL . 'assets/css/unminified/astra-widget-list-icons.css' );
		}

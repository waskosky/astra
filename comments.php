...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation" aria-label="<?php esc_html_e( 'Comments Navigation', 'astra' ); ?>">
			<h3 class="screen-reader-text"><?php astra_default_strings( 'string-comment-navigation-next' ); ?></h3>
			<div class="nav-links">
	...
	?>
		<p class="no-comments"><?php astra_default_strings( 'string-comment-closed' ); ?></p>
	<?php endif; ?>
